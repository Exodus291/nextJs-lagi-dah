...
export default function LaporanPOSPage() {
  ...
  const data = useMemo(() => generateData(periods[selectedPeriod].days), [selectedPeriod]);
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <select 
                ...
                className="px-4 py-2 bg-white/80 backdrop-blur-sm border border-pink-200 rounded-xl text-gray-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all duration-300"
              >
